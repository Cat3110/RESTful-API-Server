...
// Lookup all the checks, get their data, sent to a validator
...
// Perform the check, send the originalCheckData ant the outcome of the check process, to the next step in the process
workers.performCheck = function(originalCheckData) {
  ...
  var req = _moduleToUse.request(requestDetails, function(res) {
    ...
    // Update the checkOutcome and pass te data along
...
workers.processCheckOutcome = function(originalCheckData, checkOutcome) {
  // Decide if the check is concidered up or down
...
// Alert the user as to a chenge in their check status
workers.alertUserToStatusChange = function(newCheckData) {
  var msg = 'Alert: Your check for ' + newCheckData.method.toUpperCase() + ' ' + newCheckData.potocol  + '://' + newCheckData.url + ' is currently ' + newCheckData.state;
...
// Timer to execute the log-rotation precess nce per day
